...
plt.savefig("Italy1.png")
plt.show()

# Extracting the first PCA component for coloring
pca_component1 = reduced_embeddings[:, 1]
...
cbar = fig.colorbar(mappable=plt.cm.ScalarMappable(norm=norm, cmap='jet'), ax=ax, orientation='horizontal', fraction=0.046, pad=0.04)
cbar.set_label('PCA Component 2')

plt.title('Second PCA Component of Address Embeddings')
plt.savefig("Italy2.png")
plt.show()